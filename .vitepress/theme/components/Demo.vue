...
onMounted(() => {
  new TypeIt(block.value, {
    ...
    .type('<br><span class="token title"># ¡Bienvenido a Slidev!</span><br><br>', { delay: 400 })
    .type('Presentaciones de diapositivas para desarrolladores', { delay: 400 })
    .move('START', { speed: 0 })
    .type('<br>')
    .move('START')
    .exec(pause)
    ...
    .type('<span class="token title"># Página 2</span><br><br>', { delay: 400 })
    .type('- 📄 Escribe diapositivas en un solo archivo Markdown<br>', { delay: 800 })
    .type('- 🌈 Temas, bloques de código, componentes interactivos<br>', { delay: 800 })
    .type('- 😎 ¡Lee la documentación para saber más!', { delay: 800 })
